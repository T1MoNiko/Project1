...
const Home = () => {
    ...
    return (
        <>
            <header className={styles.homeHeader}>
                ...
                <nav>
                    ...
                    <div className={styles.btnsContainer}>
                        <ul>
                            <li className={styles.nav_btn} onClick={() => catalog.current.scrollIntoView({block: "center"})}>Catalog</li>
                            <li className={styles.nav_btn} onClick={() => footer.current.scrollIntoView({block: "center"})}>About us</li>
            ...
            <div className={styles.productsContainer} ref={catalog}>
                {state ? state.map((item) => {
                return <Card key={item.id} imageUrl={item.imageUrl} title={item.title} price={item.price} id={item.id} />   
                }) : null}
            </div>
